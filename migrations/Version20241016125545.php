 ...
 */
final class Version20241016125545 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book ADD auhtor_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE book ADD CONSTRAINT FK_CBE5A331221FC741 FOREIGN KEY (auhtor_id) REFERENCES author (id)');
        $this->addSql('CREATE INDEX IDX_CBE5A331221FC741 ON book (auhtor_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_CBE5A331221FC741 ON book');
        $this->addSql('ALTER TABLE book DROP auhtor_id');
    }
}
